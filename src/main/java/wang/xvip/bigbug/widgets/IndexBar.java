package wang.xvip.bigbug.widgets;
...
import cn.com.ichile.bigbug.R;
import wang.xvip.bigbug.utils.UIUtils;
...
public class IndexBar extends LinearLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        float indexTextSize = ta.getDimension(R.styleable.IndexBar_indexTextSize, UIUtils.spToPx
                (getContext(), 12));
